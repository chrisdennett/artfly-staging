        ...
        <div>
            ...
            <div className={'app--section app--section--dark'}>
                <GallerySign>
                    ...
                    <p className='pubicHome--smallP'>I'm hoping it'll become a place to encourage creativity, especially
                        for
                        kids.</p>
                    <p className='pubicHome--smallP'>An online gallery and art maker to encourage and celebrate every
                        artwork, big or
                        small.</p>
                </GallerySign>
            </div>
