...
import './prepareTheCanvasIcon_styles.css';

const PrepareTheCanvasIcon = function () {
    return (
        <svg className={'prepareTheCanvasIcon'} width="155.4" height="184.4" viewBox="0 0 155.4 184.4">
            <g id="cuttingBoard">
            ...
            <g id="drawing">
                ...
                <ellipse transform="rotate(45.073) skewX(.64)" cx="104.5" cy="11.28" rx="10.91" ry="10.96" fill="#fff"
                         stroke="#000" strokeWidth="1.89"/>
                <ellipse transform="rotate(45.073) skewX(.64)" cx="104.5" cy="11.28" rx="5.087" ry="5.107"
                         strokeWidth="1.89"/>
                <ellipse transform="rotate(45.073) skewX(.64)" cx="126.2" cy="11.28" rx="10.91" ry="10.96" fill="#fff"
                         stroke="#000" strokeWidth="1.89"/>
                <ellipse transform="rotate(45.073) skewX(.64)" cx="126.2" cy="11.28" rx="5.087" ry="5.107"
                         strokeWidth="1.89"/>
                <path d="M40.04 111.1l-1.732-11.48 12.1 2.764 11.59 10.87 2.534 12.59-11.24-1.754z" fill="#e9ddaf"
                      stroke="#000" strokeWidth="1.89"/>
                <ellipse transform="rotate(45.073) skewX(.64)" cx="115.8" cy="43.31" rx="5.468" ry="1.322" fill="red"
                         stroke="#000" strokeWidth="1.89"/>
                <ellipse transform="matrix(.6735 .7392 -.6665 .7455 0 0)" cx="106.9" cy="4.076" rx="3.267" ry="3.28"
                         fill="#fff" strokeWidth="1.895"/>
                <ellipse transform="matrix(.6735 .7392 -.6665 .7455 0 0)" cx="128.9" cy="3.064" rx="3.267" ry="3.28"
                         fill="#fff" strokeWidth="1.895"/>
            ...
            <g id="rightSlice">
                <rect transform="skewX(-.021)" x="124.3" y="30.5" width="7.504" height="117.9" ry="0" fill="#fff6d5"/>
                <path d="M131.7 31.51v115.9" fill="#0b4843" stroke="#000" strokeLinecap="square" strokeWidth="2"/>
            </g>
            <g id="leftSlice">
                <rect transform="" x="22" y="30.5" width="7.504" height="117.9" ry="0" fill="#fff6d5"/>
                <path d="M21.57 31.51v115.9" fill="#0b4843" stroke="#000" strokeLinecap="square" strokeWidth="2"/>
            </g>
            <g id="topSlice">
                <rect transform="matrix(0 -1 -1 .0004 0 0)" x="-31.49" y="-131.7" width="7.504" height="110" ry="0"
                      fill="#fff6d5"/>
...
export default PrepareTheCanvasIcon;