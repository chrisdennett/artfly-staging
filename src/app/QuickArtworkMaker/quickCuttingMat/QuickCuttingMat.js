...
// styles
import './quickCuttingMat_styles.css';

//https://css-tricks.com/examples/HSLaExplorer/
//http://hslpicker.com/#0f615a

const QuickCuttingMat = function ({ showSpinner = false, spinnerLabel = 'LOADING', width = 100, height = 100, colour = 'green', label = 'CROP & ROTATE' }) {
    ...
    return (
        <svg className='quickCuttingMat--svg' width={width} height={height}>
            ...
            <g transform={`translate(${matCenterX}, ${matCenterY})`}>
                ...
                <polygon className={'quickCuttingMat--spinner'}
...
export default QuickCuttingMat;
