...
const ArtworkEditor = function ({ artwork, artists, onArtistSelected, onImageUpdate }) {
    let url, artistId;
    ...
    return (
        <div>
            ...
            {url && <div style={{ width: '50%' }}><ImageCropAndRotate url={url} onImageConfirm={onImageUpdate}/></div>}
