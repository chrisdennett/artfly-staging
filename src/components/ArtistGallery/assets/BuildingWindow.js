...
const BuildingWindow = function (props) {
    return (
        <svg x={props.x} y={props.y} height="231" width="212.3" viewBox="0 0 212.31675 231.00558">
            ...
            <rect id="surroundInnerLowlight" ry="5.352" height="165.4" width="165.4" y="22.5" x="24.12" fill={props.lowlight}/>
            <path id="surroundInnderHighlight" d="M25.38 185.9c.741 1.008 2.221 1.913 4.087 1.913h154.6a5.341 5.341 0 0 0 5.352-5.354v-154.6c0-1.865-.474-2.554-1.479-3.656z" fill={props.highlight}/>
            <text id="artworkNumber" fill={props.lowlight}>
                <tspan fontWeight="900" fontSize="36" y="218.372" x="93.878" fontFamily="'Source Code Pro'">{props.number}</tspan>
            </text>
            ...
            <g id="blinds">
                ...
                <path transform="scale(1 -1)" fill="#b3b3b3" d="M33.51-161.2h145.2v1.324H33.51zM33.51-133.6h145.2v1.324H33.51zM33.51-175.5h145.2v1.324H33.51zM33.51-147.4h145.2v1.324H33.51z"/>
            </g>
            ...
            <g id="frameGroup">
                <g id="frameLowlights" fill="#444">
                    <path d="M37.96 34.5v12.51h2V36.5h11.4v-2h-13.4zM55.36 34.5v12.51h2V36.5h102v-2h-104zM163.4 34.5v12.51h2V36.5h10.51v-2H163.4zM37.96 51v105.4h2V53h11.4v-2h-13.4zM55.36 51v105.4h2V53h102v-2h-104zM163.4 51v105.4h2V53h10.51v-2H163.4zM37.96 160.4v12.74h2V162.4h11.4v-2h-13.4zM55.36 160.4v12.74h2V162.4h102v-2h-104zM163.4 160.4v12.74h2V162.4h10.51v-2H163.4z"/>
                </g>
                <path id="frame" d="M29.09 26.31v155h155.7v-155H29.09zm8.881 8.19h13.4v12.51h-13.4V34.5zm17.4 0h104v12.51h-104V34.5zm108 0h12.51v12.51h-12.51V34.5zm-125.4 16.51h13.4v105.4h-13.4V51.01zm17.4 0h104v105.4h-104V51.01zm108 0h12.51v105.4h-12.51V51.01zm-125.4 109.4h13.4v12.74h-13.4v-12.74zm17.4 0h104v12.74h-104v-12.74zm108 0h12.51v12.74h-12.51v-12.74z" fill="gray"/>
                <g id="frameHighlights" fill="#aaa">
                    <path d="M49.36 34.48v10.51h-11.4v2h13.4V34.48h-2zM157.4 34.48v10.51h-102v2h104V34.48h-2zM173.9 34.48v10.51h-10.51v2h12.51V34.48h-2zM49.36 50.99v103.4h-11.4v2h13.4V50.99h-2zM157.4 50.99v103.4h-102v2h104V50.99h-2zM173.9 50.99v103.4h-10.51v2h12.51V50.99h-2zM49.36 160.4v10.74h-11.4v2h13.4V160.4h-2zM157.4 160.4v10.74h-102v2h104V160.4h-2zM173.9 160.4v10.74h-10.51v2h12.51V160.4h-2z"/>
                </g>
            </g>
        </svg>
    )
